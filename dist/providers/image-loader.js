...
var ImageLoader = (function () {
    function ImageLoader(config, file, platform, http) {
        var _this = this;
        this.config = config;
        this.file = file;
    ...
    function () {
        ...
        if (this.currentlyProcessing[currentItem.imageUrl] === undefined) {
            this.currentlyProcessing[currentItem.imageUrl] = new Promise(function (resolve, reject) {
                ...
                _this.http.downloadFile(currentItem.imageUrl, {}, _this.config.httpHeaders, localDir + fileName).then(function (file) {
